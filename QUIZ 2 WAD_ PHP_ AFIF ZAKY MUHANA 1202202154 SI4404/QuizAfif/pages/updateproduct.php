...
<body>
     ...
     <section>
          <div class="container">
               <br>
               <h1 style="color:crimson" class="text-center">UPDATE GFUEL® PRODUCT</h1>
               <br>
               <?php
                    while ($data = mysqli_fetch_array($execute)) {
                         echo "
                              <form action='../config/update.php?id=" . $data["idproduk"] . "' method='POST' enctype='multipart/form-data'>
                                   <div class='mb-3'>
                                        <label for='nama' class='form-label'>Name of Product</label>
                                        <input type='text' id='nama' name='nama' value='" . $data["namaproduk"] . "' class='form-control' style='background-color: #EAEAEA;'>
                                   </div>
                                   <div class='mb-3'>
                                        <label for='harga' class='form-label'>Price</label>
                                        <input type='number' id='harga' name='harga' value='" . $data["hargaproduk"] . "' class='form-control' style='background-color: #EAEAEA;'>
                                   </div>
                                   <div class='mb-3'>
                                        <label for='desc' class='form-label'>Description Product</label>
                                        <textarea name='desc' id='desc' value='" . $data["deskripsi"] . "' class='form-control' rows='3' style='background-color: #EAEAEA;'></textarea>
                                   </div>
                                   <div class='mb-3'>
                                        <label for='gambar' class='form-label'>Add Picture</label>
                                        <input type='file' id='gambar' name='gambar' value='" . $data["gambarproduk"] . "' class='form-control' style='background-color: #EAEAEA;'>
                                   </div>
                                   <br>
                                   <div class='d-grid'>
