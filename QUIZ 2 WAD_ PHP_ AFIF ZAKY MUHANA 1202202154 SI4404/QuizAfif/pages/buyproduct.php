...
$mysql = "SELECT * FROM produkgfuel WHERE idproduk = $id";
     ...
     <section class="py-5">
          <div class="container px-4 px-lg-5 my-5">
               <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    echo "
                    <div class='col-md-6'>
                         <img class='card-img-top mb-5 mb-md-0 rounded' src='../img/" . $data["gambarproduk"] . "' alt='Product' />
                    </div>
                    <div class='col-md-6'>
                         <form action='../config/addpayment.php' method='POST' enctype='multipart/form-data'>
                              <div class='mb-3'>
                                   <label for='namaminuman' class='form-label'>Drink Name</label>
                                   <input type='text' class='form-control' name='namaminuman' id='namaminuman' value='" . $data["namaproduk"] . "' readonly>
                              </div>
                              <div class='mb-3'>
                                   <label for='hargaminuman' class='form-label'>Price</label>
                                   <input type='number' class='form-control' name='hargaminuman' id='hargaminuman' value='" . $data["hargaproduk"] . "' readonly>
                              </div>
                              <div class='mb-3'>
                              ...
                              <div class='mb-3'>
                                   ...
                                   <input type='text' class='form-control' name='alamatpembeli' id='alamatpembeli'>
                              </div>
                              <div class='mb-3'>
                                   ...
                                   <select name='pembayaran' class='form-select mb-3' aria-label='Pilih Pembayaran'>
                                        <option name='gopay' id='gopay' value='Gopay'>Gopay</option>
                                        <option name='ovo' id='ovo' value='Ovo'>Ovo</option>
                                        <option name='shopee' id='shopee' value='ShopeePay'>ShopeePay</option>
                                        <option name='dana' id='dana' value='Dana'>Dana</option>
                                   </select>
                              </div>
                              <div class='mb-3'>
