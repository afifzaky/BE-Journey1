          ...
          <nav class="navbar navbar-expand-lg bg-light">
               <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                         ...
                         <div class="login">
                              <a href="../QuizAfif/Pages/loginuser.php" class="btn btn-inline-dark" name="login" style="color:crimson">Login Here</a>
                         </div>
                    </div>
               </div>
          </nav>
               ...
               <footer class="py-6">
                    <div class="row">
                         ...
                         <div class="col-4" id="photos">
                              ...
                              <br>
                              <img src="https://p.kindpng.com/picc/s/202-2020299_gamma-labs-logo-png-transparent-png.png" width="200" height="90" alt="GLlogo">
                         </div>
               </footer>
          </div>
          <!-- COPYRIGHTS -->
